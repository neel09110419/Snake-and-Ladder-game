...
redstock = pygame.image.load("redstock.png")
yellowstock = pygame.image.load("yellowstock.png")
greenstock = pygame.image.load("greenstock.png")
bluestock = pygame.image.load("bluestock.png")
menubg = pygame.image.load("menu12.png")
p = pygame.image.load("playbg.jpg")
intbg = pygame.image.load("intropic14.png")
...
def play(b):
    ...
    GD.blit(redstock, (xcy, ycy))
    if 5 > b > 1 or b == 21:
        GD.blit(yellowstock, (xcy, ycy))

    if 5 > b > 2 or b == 21:
        GD.blit(greenstock, (xcg, ycg))

    if 5 > b > 2:
        GD.blit(bluestock, (xcb, ycb))
    p1 = "Player 1"
    p1score = 0
    if b == 21:
        p2 = "Computer"
    ...
    while True:
        ...
        GD.blit(redstock, (xcr, ycr))
        if 5 > b > 1 or b == 21:
            GD.blit(yellowstock, (xcy + 2, ycy))

        if 5 > b > 2:
            GD.blit(greenstock, (xcg + 4, ycg))

        if 5 > b > 3:
            GD.blit(bluestock, (xcb + 6, ycb))
